...
// --- NEW/UPDATED CODE: Comprehensive Lab Images map
const labImages = {
  "Analog Systems & Applications Lab":
    "https://5.imimg.com/data5/SELLER/Default/2024/3/404567949/BK/LE/YP/61637721/conversion-of-volt.jpg",
  Analytical:
    "https://exsrtel.ae/wp-content/uploads/2023/06/Analytical-ima.jpg",
  "Atomic Nuclear Physics Lab, Thin Film & Nanoparticles, RF & Microwave, Astrophysics":
    "https://www.leybold-shop.com/media/phk/images/versuche/p6553.jpg",
  "Basic Instrumentation Lab":
    "https://sunlabtech.com/wp-content/uploads/2019/01/Computerised-Flow-Control-Trainer.jpg",
  "Digital Systems & Applications Lab":
    "https://tiimg.tistatic.com/fp/1/007/586/mpa100-digital-melting-point-apparatus-584.jpg",
  "Electricity & Magnetism Lab":
    "https://cdn2.webdamdb.com/md_Yq2zvVxKdM81LV91.png?1752269785",
  "Electromagnetic Lab":
    "https://images-cdn.ubuy.co.in/667f2ad4c249c15de6791c54-electromagnetic-induction-coil.jpg",
  "Element of Modern Physics Lab":
    "https://5.imimg.com/data5/YI/SE/TP/SELLER-2420152/physics-lab-kit.jpg",
  "Material Science Lab":
    "https://5.imimg.com/data5/SELLER/Default/2022/6/AR/PB/YL/74698549/school-science-laboratory-material-500x500.jpeg",
  "Mechanics Lab":
    "https://sunlabtech.com/wp-content/uploads/2018/08/Steel-testing-lab-equipment.jpg",
  "Nuclear & Particles Physics Lab":
    "https://www.leybold-shop.com/media/phk/images/versuche/P6551.jpg",
  "Optics & Modern Physics Lab":
    "https://www.aticoindia.com/uploads/product_images/374692U207001-115_01_Millikan-s-Apparatus-115-V-5060-Hz-400x300.jpg",
  "Quantum Mechanics Lab":
    "https://www.qutools.com/wp-content/uploads/2017/07/1-QuEd-cropped.png",
  "Solid State Physics Lab":
    "https://www.indosawedu.com/images/thumbs-img/Study-of-pn-Junction&Energy-Band-Gap.jpg",
  "Thermal Physics & Statistical Lab":
    "https://www.acds.edu.au/wp-content/uploads/Angstmann-450x409.png",
  "Waves & Optics Lab":
    "https://cdn2.webdamdb.com/md_wg11NsMe4Cp5.png?1579793108",
  Analyticals:
    "https://www.shutterstock.com/image-photo/mass-detector-coupled-gcms-gas-600nw-2460470207.jpg",
  "Heating And Cooling":
    "https://3.imimg.com/data3/PL/BO/MY-5781294/laboratory-heating-equipment.jpg",
  Microscope:
    "https://m.media-amazon.com/images/I/61thvXHvoeL._UF1000,1000_QL80_.jpg",
  // Add more entries as needed
};

// ContactUsModal component (no changes)
...
export default function ProductShowPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-all duration-500 ease-in-out">
      {/* Hero Section */}
      <section className="relative py-10 bg-gradient-to-br from-gray-100 via-white to-gray-50 dark:from-gray-800 dark:via-gray-900 dark:to-black animate-fadeIn">
        <div
      ...
      <div className="flex relative">
        ...
        <AnimatePresence>
          {isSidebarOpen && (
            <motion.section
              ...
              className="w-full h-full overflow-y-auto md:w-[30%] lg:w-[25%] xl:w-[20%] py-12 bg-gray-50 dark:bg-gray-800 transition-colors duration-300 fixed md:relative z-20"
            >
        ...
        {/* Main Content & Products/Lab Categories Grid */}
        <motion.div
          className={`${
            isSidebarOpen
            ...
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  {labCategoryId ? "Products" : "Lab Categories"} available
                </p>
              </div>

              {/* Conditional rendering for Lab Category Cards */}
              {subcategoryId && !labCategoryId && labCategories.length > 0 ? (
                // Display Lab Category Cards when a subcategory is selected
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
                  {labCategories.map((lab) => (
                    <motion.div
                      ...
                      className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl hover:shadow-2xl transition-all duration-300 group overflow-hidden transform hover:-translate-y-2 cursor-pointer"
                    >
                      <div className="relative flex justify-center items-center p-2 overflow-hidden">
                        <img
                          // --- MODIFIED CODE: Use labImages map for the source
                          src={
                            labImages[lab.name] ||
                            "https://images.pexels.com/photos/159298/gears-cogs-machine-machinery-159298.jpeg?auto=compress&cs=tinysrgb&w=600"
                          }
                          // ---
                          alt={lab.name}
                          className="w-full h-28 object-contain rounded-lg group-hover:scale-110 transition-transform duration-500"
                        />
                      </div>
                      <div className="p-4 text-center">
                        <h3 className="text-[1rem] font-bold text-gray-900 dark:text-white line-clamp-1">
                          {lab.name}
                        </h3>
                      </div>
                    </motion.div>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {currentProducts.map((product) => (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.3 }}
                        className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl hover:shadow-2xl transition-all duration-300 group overflow-hidden transform hover:-translate-y-2 flex flex-row"
                      >
                        {/* Image Section (Left Side) */}
                        <div className="relative flex justify-center items-center p-4 overflow-hidden w-1/3">
                          <img
                            src={
                              product.image?.[0] ||
                              "https://images.pexels.com/photos/159298/gears-cogs-machine-machinery-159298.jpeg?auto=compress&cs=tinysrgb&w=600"
                            ...
                            alt={product.name}
                            className="w-[8rem] h-[7rem] object-cover rounded-lg group-hover:scale-110 transition-transform duration-500"
                          />
                        </div>
                        {/* Content Section (Right Side) */}
                        <div className="p-4 flex flex-col justify-between w-2/3">
                          <div>
                            <h3 className="text-[1rem] font-bold text-gray-900 dark:text-white line-clamp-2 mb-1">
                              {product.name}
                            </h3>
                          ...
                          {/* Buttons fixed at bottom (right side) */}
                          <div className="flex space-x-3 mt-4">
                            <button
                              onClick={() => openProductModal(product)}
                              className="flex-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200 font-semibold flex items-center justify-center space-x-2"
                            >
