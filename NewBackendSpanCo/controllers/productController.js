...
//     const subcategoryExists = await Subcategory.findById(subCategoryId).populate(
//       "parentCategories",
//       "name"
//     );
...
//     const labCategoryExists = await LabCategory.findById(labCategoryId)
...
//         success: false,
//         message: "Missing required fields: Name, Product Code (PCode), Subcategory",
//       });
//     }
...
//     // Validate labcategory exists if provided
//     if (labCategory) {
